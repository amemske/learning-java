    ...
    public static void main(String[] args) {
     ...
     // 1st Question
      ...
      //2nd  Question
        ...
        } while(!(Character.isLetter(response2) && (response2 >= 'A' && response2 <= 'D')));
        ...
        while(!(Character.isLetter(response3) && (response3 >= 'A' && response3 <= 'D')));
        ...
        while(!(Character.isLetter(response4) && (response4 >= 'A' && response4 <= 'D')));
        ...
        while(!(Character.isLetter(response5) && (response5 >= 'A' && response5 <= 'D')));
